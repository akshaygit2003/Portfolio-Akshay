...
import cv from "../../cv/myresume.pdf";
    ...
    <div className="row container">
      <div className="columns" data-aos="fade-right" data-aos-delay="300">
        ...
        <h4>
          <FormattedMessage
            id="description"
            defaultMessage="My name is Akshay Nema and I am a full stack developer."
          />
        </h4>
        <p>
          <FormattedMessage
            id="my-description"
            defaultMessage="I am strongly interested in learning new technologies and implementing them in my projects. Im a self-motivated and hardworking individual who is always ready to learn new things and work in a team"
          />
        </p>
        <ul>
          <li>
          ...
          <li>
            <p>
              <span>Hobbies: </span>
              Chess, Swimming, Badminton and Programming.
            </p>
          </li>
          <li>
            <p>
